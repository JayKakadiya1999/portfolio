...
<head>
    ...
    <meta name="description" content="Start your development with Jay Kakadiya.">
    <meta name="author" content="Devcrud">
    <title>Jay Kakadiya Portfolio</title>
    <!-- font icons -->
    <link rel="stylesheet" href="assets/vendors/themify-icons/css/themify-icons.css">
    <link rel="shortcut icon" href="assets\imgs\logo.jpg" type="image/x-icon">
	<link rel="icon" href="" type="image/png">
    <!-- Bootstrap + JohnDoe main styles -->
	<link rel="stylesheet" href="assets/css/jay.css">
</head>
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <header class="header">
        <div class="container">
            <ul class="social-icons pt-3">
                <li class="social-item"><a class="social-link text-light" href="https://www.facebook.com/jay.kakadiya.7370/"><i class="ti-facebook" aria-hidden="true"></i></a></li>
                <!--  <li class="social-item"><a class="social-link text-light" href="#"><i class="ti-twitter" aria-hidden="true"></i></a></li>
                <li class="social-item"><a class="social-link text-light" href="#"><i class="ti-google" aria-hidden="true"></i></a></li>    -->
                <li class="social-item"><a class="social-link text-light" href="https://www.instagram.com/j_a_y_kakadiya_1999/"><i class="ti-instagram" aria-hidden="true"></i></a></li>
                <li class="social-item"><a class="social-link text-light" href="https://github.com/JayKakadiya1999"><i class="ti-github" aria-hidden="true"></i></a></li>
            </ul>  
            <div class="header-content">
                <h4 class="header-subtitle" >Hello Everybody, I am</h4>
                <h1 class="header-title">Jay Kakadiya</h1>
                <h6 class="header-mono" >Web Developer</h6>
                <button class="btn btn-primary btn-rounded"><i class="ti-printer pr-2"></i><a href="assets/files/Jay_Resume.pdf" target="_jay" style="color:white" >Print Resume</a></button>
            </div>
        </div>
    </header>
        ...
        <div class="container">
            ...
            <div class="collapse mt-sm-20 navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav brand">
                    <img src="assets/imgs/logo.jpg" alt="" class="brand-img">
                    <li class="brand-txt">
                        <h5 class="brand-title">Jay Kakadiya</h5>
    ...
    <div class="container-fluid">
        <div id="about" class="row about-section">
            <div class="col-lg-4 about-card">
                ...
                <p class="mt-20">I'M A WEB DEVELOPER & PROGRAMMER LIVING IN GUJARAT,INDIA.I MAKE WEB APPLICATIONS USUALLY WITH LARAVELTHE PHP FRAMEWORK.</p>
                <button class="btn btn-outline-danger"><i class="icon-down-circled2 "></i><a href="assets/files/Jay_Resume.pdf" target="_jay">Download Resume</a> </button>
            ...
            <div class="col-lg-4 about-card">
                ...
                <ul class="mt40 info list-unstyled">
                    <li><span>Birthdate</span> : 30th June 1999</li>
                    <li><span>Email</span> : jayKakadiya1999@gmail.com</li>
                    <li><span>Phone</span> : + 91 7016624119</li>
                    <li><span>Skype</span> : live:.cid.6fb5ec22f431715 </li>
                    <li><span>Address</span> :  45,Anjana Park Society,Hirawadi Road,Saijpur Bogha,Ahmedabad-382345,India.</li>
                </ul>
                <ul class="social-icons pt-3">
                    <li class="social-item"><a class="social-link" href="https://www.facebook.com/jay.kakadiya.7370/"><i class="ti-facebook" aria-hidden="true"></i></a></li>
                    <li class="social-item"><a class="social-link" href="https://www.instagram.com/j_a_y_kakadiya_1999/"><i class="ti-instagram" aria-hidden="true"></i></a></li>
                    <li class="social-item"><a class="social-link" href="https://github.com/JayKakadiya1999"><i class="ti-github" aria-hidden="true"></i></a></li>
                </ul>  
            </div>
            <div class="col-lg-4 about-card">
                ...
                <div class="row">
                    ...
                    <div class="col-10 ml-auto mr-3">
                        <h6>Web Design</h6>
                        <p class="subtitle"> HTML,CSS,Bootstrap</p>
                        <hr>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-10 ml-auto mr-3">
                        ...
                        <p class="subtitle">Laravel PHP Framework</p>
                        <hr>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="card">
                       <div class="card-header">
                        ...
                        <div class="card-body">
                            <h6 class="title text-danger">2014-2015</h6>
                            <P>S.S.C</P>
                            <P class="subtitle">Pass out from Sardar Patel Vidhyalaya with B1 Grade(72.33%).</P>
                            <hr>
                            <h6 class="title text-danger">2016-2017</h6>
                            <P>H.S.C(COMMERCE STREAM)</P>
                            <P class="subtitle">Pass out from Sardar Patel Vidhyalaya with B1 Grade(74.85%).</P>
                            <hr>
                            <h6 class="title text-danger">2017 - 2020</h6>
                            <P>BACHELORS IN COMPUTER APPLICATION(B.C.A)</P>
                            <P class="subtitle">Pass out from Gujarat University with First Class(CGPA 6.15).</P>
                            <h6 class="title text-danger">2020 - Present</h6>
                            <P>Msc in Data Science and Analytics</P>
                            <P class="subtitle">Now studying in University of Wales Trinity Sant David(UWTSD) in the United Kingdom.</P>
    ...
    <section class="section bg-custom-gray" id="portfolio">
        <div class="container">
            <h1 class="mb-5"><span class="text-danger">My</span> Work</h1>
            <div class="portfolio">
                <!--<div class="filters">
                ...
                <div class="portfolio-container"> 
                    <div class="col-md-6 col-lg-4 web new">
                        <div class="portfolio-item">
                            <a href="https://github.com/JayKakadiya1999/DiptiHandicraft">
                                <img src="assets/imgs/handmadetree.jpg" class="img-fluid" alt="Web base application which sells hand made items">
                            </a>
                            <a class="img-popup" href="https://github.com/JayKakadiya1999/DiptiHandicraft">
                                <div class="content-holder">
                                    <div class="text-holder">
                                        
                                        <h6 class="title" style="color: white;">Dipti Handicraft</h6>
                                        <p class="subtitle">Web base application which sells handmade,Traditional and Decorative items.Download free template by click on this image.</p>
                    ...
                    <div class="col-md-6 col-lg-4 web new">
                        <div class="portfolio-item">
                            <a href="https://github.com/JayKakadiya1999/DiptiHandicraft">
                            <img src="assets/imgs/avatar.jpg" class="img-fluid" alt="Download free portfolio template.">
                            </a>
                            <a class="img-popup" href="https://github.com/JayKakadiya1999/portfolio">

                            <div class="content-holder">
                                <div class="text-holder">
                                    <h6 class="title">Portfolio</h6>
                                    <p class="subtitle">Download free portfolio template by click on this Image.</p>
                                </div>
                            </div> 
                            </a>
                        <div>                         
                    ...
                    <div class="contact-form-card">
                        ...
                        <form class="" action="send.php" method="post">
                            <div class="form-group">
                                <input  class="form-control" type="text" name="name" id="name" placeholder="Type Your Name *" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <textarea class="form-control" name="message" id="message" placeholder="Enter Your Message *" rows="7" required></textarea>
                            </div>
                            <div class="form-group ">
                                <button type="submit" name="send" class="form-control btn btn-primary" >Send Message</button>
                            </div>
                        </form>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="contact-info-card">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-10 ">
                                <h6 class="d-inline">Phone : <br> <span class="text-muted">+ 91 7016624119</span></h6>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-1 pt-1 mr-1">
                            ...
                            <div class="col-10">
                                <h6 class="d-inline">Address :<br> <span class="text-muted">45,Anjana Park Society,Hirawadi Road,Ahmedabad,Gujarat-382345,India.</span></h6>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-1 pt-1 mr-1">
                            ...
                            <div class="col-10">
                                <h6 class="d-inline">Email :<br> <span class="text-muted">jaykakadiya1999@gmail.com</span></h6>
                            </div>
                        </div>
    ...
    <footer class="footer py-3">
        <div class="container">
            <p class="small mb-0 text-light">
                &copy; <script>document.write(new Date().getFullYear())</script> Created By <a href="#" target="_blank"><span class="text-danger" title="Bootstrap 4 Themes and Dashboards">Jay Kakadiya</span></a> 
            </p>
        </div>
    </footer>
    ...
    <!-- JohnDoe js -->
    <script src="assets/js/jay.js"></script>
